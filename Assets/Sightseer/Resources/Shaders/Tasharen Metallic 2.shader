Shader "Tasharen/Metallic 2"
{
	...
	SubShader
	{
		...
		half _Specularity, _Metallic, _Smoothness, _GlowBrightness, _Condition;
		...
		void surf (Input IN, inout Output o)
		{
			...
			o.Albedo = lerp(tex.rgb, _Color.rgb * tex.rgb, mask.g * _Color.a) * IN.color.rgb;
